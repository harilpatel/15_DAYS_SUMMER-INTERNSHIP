...
$rowCount =$result->numrows; if($rowCount>0)
{
if($result)
{
...
$_SESSION["id"] = $id;
$_SESSION["email"] = $email; header("location: index.php");
...
<tr>
<td align="center"colspan="2"><font color="blue" size="6">Login Here !!</font></td>
</tr>
<tr>
...
<tr>
<td></td>
<td><input type="checkbox" name="chk1" onclick="myFunction()"  /> Show password</td>
<script>
function myFunction() {
